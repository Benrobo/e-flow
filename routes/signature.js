...
export const getSignatures = router.post(API_ROUTE.getSignatures, async (req, res) => {
    try {
        let data = req.body;
        ...
        if (Object.entries(data).length === 0) {
            return util.sendJson(res, { message: "fetching signature required a valid payload but got none" }, 404)
        }

        return Signature.get(res, data)
